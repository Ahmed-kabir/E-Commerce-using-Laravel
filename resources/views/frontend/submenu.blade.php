            ...
            <div class="container">
                ...
                <div class="col-md-8 products-right">
                    ...
                    <div class="men-wear-top">
                        <script src="{{asset('kabir/js/responsiveslides.min.js')}}"></script>
                        <script>
                        ...
                        <div  id="top" class="callbacks_container">
                            <ul class="rslides" id="slider3">
                                <li>
                                    <img class="img-responsive" src="{{asset('kabir/images/men1.jpg')}}" alt=" "/>
                                </li>
                                <li>
                                    <img class="img-responsive" src="{{asset('kabir/images/men2.jpg')}}" alt=" "/>
                                </li>
                                <li>
                                    <img class="img-responsive" src="{{asset('kabir/images/men1.jpg')}}" alt=" "/>
                                </li>
                    ...
                    <div class="men-wear-bottom">
                        <div class="col-sm-4 men-wear-left">
                            <img class="img-responsive" src="{{asset('kabir/images/men3.jpg')}}" alt=" " />
                        </div>
                    ...
                    <div class="col-md-4 product-men no-pad-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{asset('kabir/images/ep2.png')}}" alt="" class="pro-image-front">
                                <img src="{{asset('kabir/images/ep2.png')}}" alt="" class="pro-image-back">
                            ...
                            <div class="item-info-product ">
                                <h4><a href="{{url('/view')}}">Watches</a></h4>
                    ...
                    <div class="col-md-4 product-men no-pad-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{asset('kabir/images/a2.png')}}" alt="" class="pro-image-front">
                                <img src="{{asset('kabir/images/a2.png')}}" alt="" class="pro-image-back">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="col-md-4 product-men no-pad-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{asset('kabir/images/mw2.png')}}" alt="" class="pro-image-front">
                                <img src="{{asset('kabir/images/mw2.png')}}" alt="" class="pro-image-back">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="single.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                ...
                <div class="single-pro">
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="{{asset($category->product_image)}}" alt="" class="pro-image-front">
                                <img src="{{asset($category->product_image)}}" alt="" class="pro-image-back">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                            ...
                            <div class="item-info-product ">
                                ...
                                <div class="info-product-price">
                                    <span class="item_price">Tk{{$category->product_price}}</span>
